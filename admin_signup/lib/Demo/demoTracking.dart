...
import 'demoInspectDriver.dart';

class DemoTrackingScreen extends StatefulWidget {
  const DemoTrackingScreen({super.key});

  @override
  DemoTrackingScreenState createState() => DemoTrackingScreenState();
}

var driverEmail;

class DemoTrackingScreenState extends State<DemoTrackingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(
            child: const Text('Demo', style: TextStyle(color: Colors.black))),
